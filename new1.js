...
}(jQuery), void 0 === jQuery) && (jQuery = "function" == typeof require ? $ = require("jQuery") : $);
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            var n, r = i(t),
                ...
                h = r.path,
                f = p[u] && h in p[u].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || f ? (c("ignoring socket cache for %s", s), n = a(s, e)) : (p[u] || (c("new io instance for %s", s), p[u] = a(s, e)), n = p[u]), r.query && !e.query && (e.query = r.query), n.socket(r.path, e)
        }
        ...
        function o() {
            ...
            return !1
        }, e.humanize = n(6), e.instances = [], e.names = [], e.skips = [], e.formatters = {}
    }, function(t, e) {
        function n(t) {
        ...
        t.exports = function(t, e) {
            ...
            if ("number" === r && !1 === isNaN(t)) return e.long ? n(t) : function(t) {
        ...
        var p = n(3)("socket.io-parser"),
            ...
            f = n(10),
            l = n(11);
        e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = r, e.Decoder = i;
        var d = e.ERROR + '"encode error"';
        r.prototype.encode = function(t, n) {
            (p("encoding packet %j", t), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type) ? function(t, e) {
        ...
        var o = n(15),
            ...
            p = n(2),
            u = n(29);
        t.exports = r, r.priorWebsocketSuccess = !1, i(r.prototype), r.protocol = c.protocol, r.Socket = r, r.Transport = n(20), r.transports = n(15), r.parser = n(21), r.prototype.createTransport = function(t) {
        ...
        function r(t) {
            t && t.forceBase64 && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = o && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (f = i), s.call(this, t)
        }
        var o, i, s = n(20),
            a = n(21),
            c = n(29),
        ...
        t.exports = r, p(r, s), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function() {
            ...
            for (var n = t.length, r = 0, o = n; r < o; r++) ! function(t) {
                a.encodePacket(t, e.supportsBinary, function(r) {
                    if (!e.usingBrowserWebSocket) {
                        var o = {};
                        if (t.options && (o.compress = t.options.compress), e.perMessageDeflate)("string" == typeof r ? Buffer.byteLength(r) : r.length) < e.perMessageDeflate.threshold && (o.compress = !1)
                    }
                    try {
            ...
            var t = this.query || {},
                ...
                n = "";
            return this.port && ("wss" === e && 443 !== Number(this.port) || "ws" === e && 80 !== Number(this.port)) && (n = ":" + this.port), this.timestampRequests && (t[this.timestampParam] = u()), this.supportsBinary || (t.b64 = 1), (t = c.encode(t)).length && (t = "?" + t), e + "://" + (-1 !== this.hostname.indexOf(":") ? "[" + this.hostname + "]" : this.hostname) + n + this.path + t
...
$(document).ready(function () {
    ...
    function processMarque () {
        ...
        if (toShowLen === 5) {
            // mumbai result
            html = `
                <div id="live-update-` + toShow[0] + `" class="alert alert-info alert-dismissible fade in liveupdate text-center">
                    <div class="livename">` + toShow[1] + `</div> 
                    <div data-update="live-update-` + toShow[0] + `">
                        <span class="livepana">` + toShow[2] + ` - </span><span class="livejodi ` + (reds.includes(toShow[3]) ? 'makeRed' : 'makeBlack') + `">` + toShow[3] + `</span><span class="livepana"> - ` + toShow[4] + `</span>
                    </div>    
    			</div>`;
        } else if (toShowLen === 4) {
            // handles loading of mumbai side only
            html = `
                 <div id="live-update-` + toShow[0] + `" class="alert alert-info alert-dismissible fade in liveupdate text-center">
                    <div class="livename">` + toShow[1] + `</div> 
                    <div data-update="live-update-` + toShow[0] + `">`;
            if (toShow[2].trim() !== '') html += `
                        <span class="livepana">` + toShow[2] + ` - </span>
                        <span class="livejodi ` + (reds.includes(toShow[3]) ? 'makeRed' : 'makeBlack') + `">` + toShow[3] + `</span>`;
            else html += `<span class="livepana"> Loading...</span>`;
            html += `</div>    
    			</div>`;
        } else if (toShowLen === 3) {
            // delhi result
            ...
            // show loading, handles delhi side only
            html = `
                <div id="live-update-` + toShow[0] + `" class="alert alert-info alert-dismissible fade in liveupdate text-center">
                    <div class="livename">` + toShow[1] + `</div>
                    <div data-update="live-update-` + toShow[0] + `">
                        <span class="livepana"> Loading...</span>
                    </div>
    			</div>`;
        }
    ...
    function processMumbaiGames () {
        var games = JSON.parse($('#mumbai-game-details').val());
        ...
        for (var gameId in games) {
            ...
            var [gamename, time1, time2, a1a2a3, a] = games[gameId];
            ...
            if (    
                    ((currentDateMinutes < preDateTime2Minutes) && ((currentDateMinutes + timeoutAfter) > preDateTime2Minutes)) ||
                    ((currentDateMinutes < preDateTime1Minutes) && ((currentDateMinutes + timeoutAfter) > preDateTime1Minutes))
                ) {
                ...
                var html = `<div id="live-update-`+ gameId + `" class="update-item">
                                <div class="gamename-head">
                                    <span style="display: inline-flex;">`+ gamename +`
                ...
                if (a1a2a3.trim() === 'Loading...') {
                     html += `
                                    <span class="livepana" data-pana="">Loading...</span>
                                    <span class="livejodi gamename-head"></span>`;
                } else {
                    if (a1a2a3.trim()) html += `
                ...
                if (a1a2a3 !== 'Loading...') marqueAsArray.push([gameId, gamename, a1a2a3, a]);
                else marqueAsArray.push([gameId, gamename, '', '']);
                expiry(gameId);
            }
        }
    }
    function processDelhiGames () {
        var games = JSON.parse($('#delhi-game-details').val());
        var currentDate = new Date();
        for (var gameId in games) {
            // if we have the div we don't add it
            if ($('#live-update-' + gameId).length > 0) {
            ...
            var [gamename, time1] = games[gameId];
            var dateStr = currentDate.toLocaleDateString();
            var preDateTime1 = new Date(dateStr + ' ' + time1);
            ...
            var currentDateMinutes = currentDate.getHours() * 60 + currentDate.getMinutes();
            if (
                (currentDateMinutes < preDateTime1Minutes) && 
                ((currentDateMinutes + timeoutAfter) > preDateTime1Minutes)
            ) {
                // time1 is within range. so we should make it visible
                var html = `<div id="live-update-`+ gameId + `" class="update-item">
                                <div class="gamename-head">
                ...
                $('#live-updates').append(html);
                marqueAsArray.push([gameId, gamename]);
                expiry(gameId);
            }
        }
    }
    ...
    socket.on("listen", (result) => {
    	...
    	if (res !== 'Error') {
    		if (res.type == 'mumbai') {
    		    ...
    		    var updateHtml = `
    		        <span class="livepana" data-pana="">` + res.a1 + res.a2 + res.a3 + ` - </span><span class="livejodi gamename-head">` + res.a.join('') + `</span><span class="livepana"> - ` + res.a4 + res.a5 + res.a6 + `</span>
    		    `;
    		  //  add realtime data
    		  ...
    		  //  remove loader
    		    ...
    		    marqueAsArray = marqueAsArray.map(function (item) {
    		        if (item[0] === res.target) return  item.concat([res.a1 + res.a2 + res.a3, res.a, res.a4 + res.a5 + res.a6]);
    		        else return item;
    		    });
    ...
    // 			remove loader
    			$('[data-update-loader="live-update-' + res.target + '"]').remove();
    			marqueAsArray = marqueAsArray.map(function (item) {
    		        if (item[0] === res.target) return  item.push(res.a);
    		        else return item;
    		    });
